...
rds1 <- file.path(base_dir,
  ...
  "neuronchat_18_merged_AG_031826.28celltypes.AD_at_the_end.rds")
...
if (length(only1) > 0 || length(only2) > 0) {
  ...
  # Subset @net and @idents to common cell types only
  subset_neuronchat <- function(obj, keep_ct) {
    # Subset @net — each pathway matrix
    ...
    # Subset @data and @data.signaling to matching cells
