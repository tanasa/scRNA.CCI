# SINGLE-SAMPLE ANALYSIS — Healthy
...
rds_seurat <- file.path(base_dir,
						  "18_merged_AG_031826.28celltypes.Healthy.rds")
...
log_file   <- file.path(out_dir,
						  paste0("neuronchat_Healthy_28celltypes_",
							 				          format(Sys.time(), "%Y%m%d_%H%M%S"), ".log"))
start_time <- Sys.time()
sink(log_file, split = TRUE)

cat("╔═══════════════════════════════════════════════════════════╗\n")
cat("║  NeuronChat Single-Sample: Healthy (subcelltype / 28ct)  ║\n")
cat("╚═══════════════════════════════════════════════════════════╝\n")
...
cat("\n")
cat("╔═══════════════════════════════════════════════════════════╗\n")
cat("║  ✓✓✓  NeuronChat Healthy COMPLETE  ✓✓✓                   ║\n")
cat("╚═══════════════════════════════════════════════════════════╝\n")
cat("Output:", rds_out, "\n")
