# SINGLE-SAMPLE ANALYSIS — Dyslexia  (script v5)
...
# ── Sample / paths ────────────────────────────────────────────────
sample_name <- "18_merged_AG_031826.28celltypes.Dyslexia"
...
rds_seurat <- file.path(base_dir, "18_merged_AG_031826.28celltypes.Dyslexia.rds")
out_dir <- file.path(base_dir, "18_merged_AG_031826.28celltypes.Dyslexia_neuronchat")
...
log_file <- file.path(out_dir,
  paste0("neuronchat_Dyslexia_28celltypes_v5_", format(Sys.time(), "%Y%m%d_%H%M%S"), ".log"))
start_time <- Sys.time()
sink(log_file, split = TRUE)

cat("╔═══════════════════════════════════════════════════════════╗\n")
cat("║  NeuronChat Single-Sample: Dyslexia v5 (subcelltype / 28ct)   ║\n")
cat("╚═══════════════════════════════════════════════════════════╝\n")
...
# ── Final RDS + manifest ──────────────────────────────────────────
cat("\n=== Saving RDS ===\n")
rds_out <- file.path(out_dir, "neuronchat_18_merged_AG_031826.28celltypes.Dyslexia_at_the_end_v5.rds")
...
cat("\n╔═══════════════════════════════════════════════════════════╗\n")
cat("║  ✓ NeuronChat Dyslexia v5 COMPLETE                              ║\n")
cat("╚═══════════════════════════════════════════════════════════╝\n")
