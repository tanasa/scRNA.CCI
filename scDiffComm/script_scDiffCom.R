...
rds_file        <- "18_merged_AG_031826.28celltypes.AD_vs_Dyslexia.rds"
analysis_name   <- "AD_vs_Dyslexia_v3_18_merged_AG_031826.28celltypes.AD_vs_Dyslexia"                    # used in filenames
condition_col   <- "group"                                # metadata column
cond1           <- "AD"
cond2           <- "Dyslexia"
celltype_col    <- "subcelltype"
scdiffcom_name  <- "scDiffCom_AD_vs_Dyslexia_v3_18_merged_AG_031826.28celltypes.AD_vs_Dyslexia"          # name stored inside the object
